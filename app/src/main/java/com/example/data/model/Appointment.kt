...
data class JobReport(
    ...
    val paymentStatus: String = "Bekliyor", // Ödendi, Kısmi, Bekliyor
    val paymentMethod: String = "", // Nakit, Kredi Kartı, EFT/Havale
    val paymentPromiseDate: String = "",
...
data class Appointment(
    ...
    val status: AppointmentStatus = AppointmentStatus.BEKLIYOR,
